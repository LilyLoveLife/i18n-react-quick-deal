...
var astTraverse = function (filePath) {
    ...
    traverse(ast, {
        StringLiteral: function (path) {
            var node = path.node, parentPath = path.parentPath; // parentPath是null ???
            if (isChinese(node.value)) {
                var parentNode = parentPath === null || parentPath === void 0 ? void 0 : parentPath.node;
                var translated = (parentNode === null || parentNode === void 0 ? void 0 : parentNode.type) === 'CallExpression'
...
var writeFile = function (jsonStr_toTraslate, directoryPath, fileName) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
...
var extractChinese = function () {
    ...
    var destinateDirPath = path.join(projectRoot, "./src/locale/toTranslate/");
    var destinateFileName = new Date().getTime() + ".json";
