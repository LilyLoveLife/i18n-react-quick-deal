    ...
    traverse(ast, {
        ...
        StringLiteral: function (path) {
            ...
            if (includesChinese(node.value)) {
                var translated = ((_a = parentPath === null || parentPath === void 0 ? void 0 : parentPath.node) === null || _a === void 0 ? void 0 : _a.type) === 'CallExpression' && parentPath.node.callee.type === 'Identifier' && ((_b = parentPath.node.callee) === null || _b === void 0 ? void 0 : _b.name) === FuncName;
                if (translated) {
                    return;
                }
